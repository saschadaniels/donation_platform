...
class TranslationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create translation" do
    assert_difference('Translation.count') do
      post translations_url, params: { translation: { description: @translation.description, item_id: @translation.item_id, name: @translation.name } }
    end
  ...
  test "should update translation" do
    patch translation_url(@translation), params: { translation: { description: @translation.description, item_id: @translation.item_id, name: @translation.name } }
